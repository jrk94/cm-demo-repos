...
import {
    AiAgentTask,
    AiAgentSettings
} from "../../../../src/tasks/aiAgent/aiAgent.task";

describe("AiAgent Task tests", () => {


    // Optional: See container handling under aiAgentTestFactory
     ...
     *
     * You, as the tester developer, will trigger the outputs necessary for the AiAgent to be activated
     * and check the changes to see if the AiAgent task sent you the correct values
     *
