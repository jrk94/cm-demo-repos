...
export const SETTINGS_DEFAULTS: PostMultipleTelemetrySettings = {
    applicationName: "MES",
    eventTime: null,
    retries: 30,
 ...
 *
 * ### Settings
 * See {@see PostMultipleTelemetrySettings}
 */
@Task.Task()
export class PostMultipleTelemetryTask extends TaskBase implements PostMultipleTelemetrySettings {
...
// Add settings here
/** PostMultipleTelemetry Settings object */
export interface PostMultipleTelemetrySettings extends System.TaskDefaultSettings {
    /** Application name */
