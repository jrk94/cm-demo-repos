...
export class PostOvenTelemetryTask extends TaskBase implements PostOvenTelemetrySettings {
    ...
    private transformDataIntoParameters(ovenData: OvenData, timestamp: string): any[] {
    ...
    private transformDataIntoTags(ovenData: OvenData, timestamp: string): PostTelemetry["Tags"] {
    ...
    private async createData(
        ...
        return {
            Parameters: this.transformDataIntoParameters(zoneData, new Date(valuesTimestamp).valueOf().toString()),
            Tags: this.transformDataIntoTags(zoneData, new Date(valuesTimestamp).valueOf().toString()),
