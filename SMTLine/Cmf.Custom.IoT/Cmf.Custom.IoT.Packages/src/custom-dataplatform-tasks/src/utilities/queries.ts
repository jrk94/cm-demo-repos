...
/*
* Helper Class to create MES query objects
*/
export class Queries {

    /**
     * Create a query to resolve the ISA95 having a Resource
     *
     * @param resourceName - Name of MES Resource.
     * @returns An MES query object.
     */
    ...
    /**
     * Create a query to resolve the ISA95 having an Area name
     *
     * @param areaName - Name of MES Area.
     * @returns An MES query object.
     */
    ...
    /**
     * Create a query to resolve the ISA95 having an Facility name
     *
     * @param facilityName - Name of MES Facility.
     * @returns An MES query object.
     */
    ...
    /**
     * Create a query to resolve the ISA95 having a Site name
     *
     * @param siteName - Name of MES Site.
     * @returns An MES query object.
     */
