...
//     BlackBoxTask,
//     BlackBoxSettings
// } from "../../../../src/tasks/blackBox/blackBox.task";

// describe("BlackBox Task tests", () => {


//     // Optional: See container handling under blackBoxTestFactory
...
//     const blackBoxTestFactory = (settings: BlackBoxSettings | undefined, trigger: Function, validate: Function): void => {
...
//      *    1 - Mockup task
//      *
//      * All Outputs of Mock task are connected to the inputs of the BlackBox task
//      * All Outputs of BlackBox Task are connected to the Mock task inputs
//      *
//      * You, as the tester developer, will trigger the outputs necessary for the BlackBox to be activated
//      * and check the changes to see if the BlackBox task sent you the correct values
//      *
