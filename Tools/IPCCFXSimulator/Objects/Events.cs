            ...
            {
                {
                    ...
                    new ReflowProcessData()
                    {
                        ...
                        ZoneData = JsonConvert.DeserializeObject<List<CFX.Structures.SolderReflow.ReflowZoneData>>(ZoneData_SMT_Product_A)
                    }
                },
                {
                    "SMT_Product_B",
                    new ReflowProcessData()
                    {
                        ConveyorSpeed = 100,
                        ConveyorSpeedSetpoint = 100,
                        ZoneData = JsonConvert.DeserializeObject<List<CFX.Structures.SolderReflow.ReflowZoneData>>(ZoneData_SMT_Product_B)
                    }
                },
                {
                    "SMT_Product_C",
                    new ReflowProcessData()
                    {
                        ConveyorSpeed = 100,
                        ConveyorSpeedSetpoint = 100,
                        ZoneData = JsonConvert.DeserializeObject<List<CFX.Structures.SolderReflow.ReflowZoneData>>(ZoneData_SMT_Product_C)
                    }
                },
                {
                    "SMT_Product_D",
                    new ReflowProcessData()
                    {
                        ConveyorSpeed = 100,
                        ConveyorSpeedSetpoint = 100,
                        ZoneData = JsonConvert.DeserializeObject<List<CFX.Structures.SolderReflow.ReflowZoneData>>(ZoneData_SMT_Product_D)
                    }
                }
            };
        }
