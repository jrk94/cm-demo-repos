...
namespace SMTSimulator
{
    internal class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<SMTSimulator.Services.ITokenService, SMTSimulator.Services.TokenService>();
            builder.Services.AddSingleton<SMTSimulator.Services.IEventsService, SMTSimulator.Services.EventsService>();
            builder.Services.AddTransient<ScenarioRunner>(provider =>
                new ScenarioRunner(
                    provider.GetRequiredService<SMTSimulator.Services.IEventsService>(),
                    speed,
                    defectProbability,
                    terminateOnStart));
