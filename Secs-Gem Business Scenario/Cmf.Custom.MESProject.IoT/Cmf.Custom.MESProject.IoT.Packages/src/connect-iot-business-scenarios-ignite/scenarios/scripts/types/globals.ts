...
type EventMapping = Map<string,
    {
        dataCollection: Cmf.Navigo.BusinessObjects.DataCollection,
        dataCollectionMode: "Perform to Resource" | "Perform to First Material In Resource" | "Perform to All Materials In Resource",
        rptidAndSvidList: {
            rptid: string,
            svidList: Map<string,
                {
                    ...
                    dataType: DataType,
                    parameter: Cmf.Navigo.BusinessObjects.Parameter
                }>
        }[]
    }>;

export { ScriptScopeBase, EventMapping };