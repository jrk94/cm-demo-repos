...
describe("QuerySQLiteNestedArray Task tests", () => {
    ...
    // Optional: See container handling under querySQLiteNestedArrayTestFactory
    ...
    const querySQLiteNestedArrayTestFactory = (settings: QuerySQLiteNestedArraySettings | undefined, trigger: Function, validate: Function): void => {

        const taskDefinition = {
            class: QuerySQLiteNestedArrayTask,
            id: "0",
            settings: (settings || {
                tableName: "",
                arrayPath: "",
     ...
     *    0 - QuerySQLiteNestedArray Task
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the QuerySQLiteNestedArray task
     * All Outputs of QuerySQLiteNestedArray Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the QuerySQLiteNestedArray to be activated
     * and check the changes to see if the QuerySQLiteNestedArray task sent you the correct values
     *
