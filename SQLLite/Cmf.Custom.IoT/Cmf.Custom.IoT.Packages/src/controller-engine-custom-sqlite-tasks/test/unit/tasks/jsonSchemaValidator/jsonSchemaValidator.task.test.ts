...
describe("JsonSchemaValidator Task tests", () => {
    ...
    // Optional: See container handling under jsonSchemaValidatorTestFactory
    ...
    const jsonSchemaValidatorTestFactory = (settings: JsonSchemaValidatorSettings | undefined, trigger: Function, validate: Function): void => {

        const taskDefinition = {
            class: JsonSchemaValidatorTask,
            id: "0",
            settings: (settings || {
                throwOnSchemaValidationFailure: false,
            } as JsonSchemaValidatorSettings)
        };
     ...
     *    0 - JsonSchemaValidator Task
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the JsonSchemaValidator task
     * All Outputs of JsonSchemaValidator Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the JsonSchemaValidator to be activated
     * and check the changes to see if the JsonSchemaValidator task sent you the correct values
     *
    ...
    it("should get success when activated", (done) => {
        jsonSchemaValidatorTestFactory(undefined,
