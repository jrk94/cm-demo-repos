...
describe("QuerySQLiteByPath Task tests", () => {
    ...
    // Optional: See container handling under querySQLiteByPathTestFactory
    ...
    const querySQLiteByPathTestFactory = (settings: QuerySQLiteByPathSettings | undefined, trigger: Function, validate: Function): void => {

        const taskDefinition = {
            class: QuerySQLiteByPathTask,
            id: "0",
            settings: (settings || {
                tableName: "",
     ...
     *    0 - QuerySQLiteByPath Task
     *    1 - Mockup task
     *
     * All Outputs of Mock task are connected to the inputs of the QuerySQLiteByPath task
     * All Outputs of QuerySQLiteByPath Task are connected to the Mock task inputs
     *
     * You, as the tester developer, will trigger the outputs necessary for the QuerySQLiteByPath to be activated
     * and check the changes to see if the QuerySQLiteByPath task sent you the correct values
     *
