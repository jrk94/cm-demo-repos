...
//     // Optional: See container handling under flexibleQuerySQLiteTestFactory
...
//     const flexibleQuerySQLiteTestFactory = (settings: FlexibleQuerySQLiteSettings | undefined, trigger: Function, validate: Function): void => {

//         const taskDefinition = {
//             class: FlexibleQuerySQLiteTask,
//             id: "0",
//             settings: (settings || {
//                 example: "Hello World",
...
//      *    0 - FlexibleQuerySQLite Task
//      *    1 - Mockup task
//      *
//      * All Outputs of Mock task are connected to the inputs of the FlexibleQuerySQLite task
//      * All Outputs of FlexibleQuerySQLite Task are connected to the Mock task inputs
//      *
//      * You, as the tester developer, will trigger the outputs necessary for the FlexibleQuerySQLite to be activated
//      * and check the changes to see if the FlexibleQuerySQLite task sent you the correct values
//      *
