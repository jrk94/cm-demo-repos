...
describe("UnsTreeMaker Task tests", () => {
            ...
            (changes: Task.Changes) => {
                if (changes["dataOut"]) {
                    ...
                    chai.expect(eventNameEntry.topic).to.equal(
                        "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/name"
                    );
                    ...
                    chai.expect(rawEntry.topic).to.equal(
                        "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/raw"
                    );
                    ...
                    const headerCorrelationIdEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/CorrelationId"
                    );
                    ...
                    const headerDateTimeEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/DateTime"
                    );
                    ...
                    const headerApplicationEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/Application"
                    );
                    ...
                    const headerServiceEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/Service"
                    );
                    ...
                    const headerOperationEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/Operation"
                    );
                    ...
                    const headerCDMVersionEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/CDMVersion"
                    );
                    ...
                    const headerStartDateTimeEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/event/StartDateTime"
                    );
                    ...
                    const enterpriseUIDEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/node/assetidentifier/assetid"
                    );
                    ...
                    const enterpriseNameEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/node/assetidentifier/assetname"
                    );
                    ...
                    const siteUIDEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/node/assetidentifier/assetid"
                    );
                    ...
                    const siteNameEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/node/assetidentifier/assetname"
                    );
                    ...
                    const facilityUIDEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/node/assetidentifier/assetid"
                    );
                    ...
                    const facilityNameEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/node/assetidentifier/assetname"
                    );
                    ...
                    const areaUIDEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/node/assetidentifier/assetid"
                    );
                    ...
                    const areaNameEntry = result.find(r =>
                        r.topic === "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/node/assetidentifier/assetname"
                    );
    ...
    it("should emit success and dataOut with correct topics for material operation light event", (done) => {
        ...
        const resourceBase = "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/COLORING_01";
        const areaBase = "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication";
    ...
    it("should emit success and dataOut with correct topics for resource state change light event", (done) => {
        ...
        const resourceBase = "CM/MachineMakers/Europe-West/Production-InduTech/Final-Assembly/BAY0";
        const areaBase = "CM/MachineMakers/Europe-West/Production-InduTech/Final-Assembly";
    ...
    it("should emit success and dataOut with correct topics for metrics event", (done) => {
        ...
        const resourceBase = "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication/FOAM-PREP";
        const areaBase = "CM/MachineMakers/Europe-West/Production-InduTech/Fabrication";
